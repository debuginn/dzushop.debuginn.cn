...
if(dialogFirst==true){
  ...
  temp_float+="<div class=\"title\"><h4></h4><span id=span_close>关闭</span></div>";
  temp_float+="<div class=\"content\" style='width:700px;'></div>";
  temp_float+="</div>";
...
$("#span_close").click(function(){
  $("#floatBoxBg").hide();
  $("#floatBox").css({top:-4000+"px"},"normal",function(){$(this).hide();});
  $("#selectOS").show();
  $("#select2").show(); 
});
...
$("#floatBox").css({left:(($(document).width())/2-(parseInt(width)/2))+"px",top:130,width:width,height:height});
$("#floatBoxBg").show();
