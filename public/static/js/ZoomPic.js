...
//		this.timer = 1000;
		...
		this.options = [
			...
			{width:418, height:740, top:83, left:-52, zIndex:1},
			{width:452, height:800, top:33, left:100, zIndex:2},
			{width:489, height:866, top:0, left:347, zIndex:3},
			{width:452, height:800, top:33, left:630, zIndex:2},
			{width:418, height:740, top:83, left:800, zIndex:1},
		];
	...
	setUp : function ()
	{
		...
		for (i = 0; i < this.aSort.length; i++)
		{
			...
			if (i < 5)
			{
				...
				{
					_this.doMove(_this.aSort[_this.iCenter].getElementsByTagName("span")[0], {opacity:100}, function ()
					{
						_this.doMove(_this.aSort[_this.iCenter].getElementsByTagName("span")[0], {opacity:100}, function ()
						{
