    ...
    <div class="admin-content">
        <div class="row admin-head">
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="admin-head-left">
                    ...
                    <text class="text-muted">&nbsp;&nbsp;/&nbsp;&nbsp;</text>
                    <text class="text-info">修改轮播图</text>
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="row admin-box">
            <div class="col-md-6 admin-pic-create-box1">
                <h4 class="card-title"><strong>修改轮播图操作</strong></h4>
                ...
                <form class="forms-sample">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputTitle" name="title" placeholder="请输入标题名称" value="{{ $data->title }}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputSort">链接：</label>
                        <input type="text" class="form-control" id="exampleInputSort" name="href" placeholder="请输入链接" value="{{ $data->href }}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputSort">排序：</label>
                        <input type="number" class="form-control" id="exampleInputSort" name="sort" placeholder="请输入排序" value="{{ $data->sort }}">
                    </div>
                    <div class="form-group">
                        <label>上传轮播图：</label>
                        ...
                        <div class="input-group col-xs-12">
                            ...
                            {{-- 设置上传回调图像URL地址--}}
                            <input type="hidden" name="img" value="{{ url($data->img) }}">
                        </div>
                    </div>
                    <hr>
