    ...
    <div class="admin-content">
        <div class="row admin-head">
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="admin-head-left">
                    ...
                    <text class="text-muted">&nbsp;&nbsp;/&nbsp;&nbsp;</text>
                    <text class="text-info">添加广告</text>
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="row admin-box">
            <div class="col-md-6 admin-pic-create-box1">
                <h4 class="card-title"><strong>添加广告操作</strong></h4>
                ...
                <form class="forms-sample">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputTitle" name="title" placeholder="请输入广告标题名称">
                    </div>
                    <div class="form-group">
